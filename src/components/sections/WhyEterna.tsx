...
export default function WhyEterna() {
  return (
    <section className="relative min-h-screen py-32 lg:py-48 bg-black overflow-hidden flex flex-col justify-center">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[#2dd4bf]/5 mix-blend-color" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-[1400px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 lg:gap-32 items-start">
          ...
          <div className="flex flex-col gap-16">
            ...
            >
              We built a platform that doesn't. Accessible, clinically guided 
              optimization from home — designed to meet you where you are, 
              not where the system wants you to be.
            </motion.p>
                ...
                {[
                  ...
                  <div key={idx} className="flex gap-8 group">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <h4 className="text-2xl font-title font-medium text-[#1a2b32] tracking-tight">{item.title}</h4>
                      <p className="text-[#1a2b32]/50 text-base leading-relaxed font-body font-normal">{item.text}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              {
                icon: <Building2 className="text-[#2dd4bf]" size={20} />,
              ...
              {
                icon: <Thermometer className="text-[#2dd4bf]" size={20} />,
              ...
              >
                <div className="flex gap-8 items-start">
                  ...
                  <div className="flex flex-col gap-2">
                    <h4 className="text-2xl font-title font-medium text-white leading-tight tracking-tight">{card.title}</h4>
                    <p className="text-white/40 text-sm md:text-base leading-relaxed font-body font-normal">{card.text}</p>
                  </div>
                </div>
              </motion.div>
            ))}
